...
// BrightVolt Electric — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Electrical Repairs', 'Panel Upgrade', 'Wiring & Rewiring',
  'Lighting Installation', 'EV Charger Installation', 'Generator Installation',
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 715-4400. We answer 7 days a week including evenings. For a genuine electrical emergency in Central Texas, call — don't wait on a form response.",
  },
  {
  ...
  {
    question: 'Do you work on commercial electrical systems?',
    answer: 'Yes — light commercial electrical for restaurants, offices, retail spaces, and small warehouses is within our scope. Call to discuss your specific system and location.',
  },
  {
  ...
  return (
    <main className={styles.page}>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@brightvoltelectric.com',
                  href:      'mailto:hello@brightvoltelectric.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '822 Colcord Ave, Waco TX 76707',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose BrightVolt</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '1-year parts & labor warranty on every repair',
                'TECL-licensed Master Electricians only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A licensed BrightVolt electrician will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12547154400">(254) 715-4400</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 715-4400 — we answer 7 days a week, evenings included. Emergency service available across Central Texas."
        primaryText="Call (254) 715-4400"
        primaryLink="tel:+12547154400"
        secondaryText="Send a Text"
        secondaryLink="sms:+12547154400"
      />
