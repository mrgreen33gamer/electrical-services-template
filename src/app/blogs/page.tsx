    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>BrightVolt Electric — Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Practical electrical safety tips, panel upgrade guidance, and EV charger advice for Central Texas homeowners.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need a licensed electrician in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We&apos;ve been powering Waco-area homes and businesses with expert electrical repair, panel upgrades, and installations since 2010. Free estimate, no obligations.
            </p>
