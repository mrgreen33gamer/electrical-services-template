// src/app/layout.tsx
// BrightVolt Electric — root layout
//
...
import { Orbitron, Space_Grotesk, IBM_Plex_Sans } from "next/font/google";
import "./globals.css";
...
// ── FONTS — Orbitron / Space Grotesk / IBM Plex Sans (industrial neon) ───────
...
const BASE_URL = isProduction
  ? "https://www.brightvoltelectric.com"
  : "http://localhost:3000";
...
export const metadata: Metadata = {
  ...
  title: {
    default: "BrightVolt Electric | Panel Upgrades, Wiring & Electrical Repair — Waco, TX",
    template: "%s | BrightVolt Electric",
  },
  description:
    "BrightVolt Electric is a Waco, TX electrical contractor offering panel upgrades, wiring & rewiring, lighting installation, electrical repairs, EV charger installation, and generator installation for Central Texas homes and businesses. TECL-licensed, local, no contracts.",
  keywords: [
    "BrightVolt Electric",
    "electrician Waco TX",
    "electrical panel upgrade Waco Texas",
    "wiring and rewiring Waco",
    "electrical repair Central Texas",
    "EV charger installation Waco TX",
    "electrical contractor Hewitt TX",
    "generator installation Waco",
    "emergency electrician Waco",
  ],
  authors: [{ name: "BrightVolt Electric", url: BASE_URL }],
  creator: "BrightVolt Electric",
  publisher: "BrightVolt Electric",
  icons: {
  ...
  openGraph: {
    title: "BrightVolt Electric | Panel Upgrades, Wiring & Electrical Repair — Waco, TX",
    description:
      "Waco-based electrical contractor for panel upgrades, wiring, lighting, EV chargers, generators, and electrical repairs across Central Texas. TECL-licensed & insured. No contracts.",
    url: BASE_URL,
...
const localBusinessSchema = {
  ...
  alternateName: "BrightVolt Electric Waco",
  description:
    "Residential and commercial electrical services in Waco and Central Texas — panel upgrades, wiring & rewiring, lighting installation, electrical repairs, EV charger installation, and generator installation. TECL-licensed, bonded & insured, 2-Year Workmanship Warranty.",
  url: BASE_URL,
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Lighting Installation & Design" } },
      ...
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Generator Installation & Backup Power" } },
    ],
  },
  aggregateRating: {
        ...
        <MapProvider>
          <Suspense
            fallback={
              ...
              >
                <PulseLoader size={50} color="#00d4ff" />
              </div>
            }
          >
