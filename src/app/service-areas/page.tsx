...
// BrightVolt Electric — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full electrical repair, panel upgrades, wiring, lighting, EV chargers, and generators across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full electrical coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
    highlights:  ['45-min dispatch', 'Residential & commercial', 'Panel upgrades'],
  },
  {
    city:        'Woodway',
    slug:        'woodway-tx',
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and 2-Year Workmanship Warranty as every other area we cover.",
    highlights:  ['Flat-rate pricing', '2-Year Workmanship Warranty', 'TECL-licensed'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable electrical service for Bellmead residents and businesses. Panel upgrades, repairs, and lighting installs — same-day when available.',
    highlights:  ['Residential & commercial', 'TECL-licensed electricians', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential electrical service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Electrical repair, panel upgrades, and shop power for McGregor homes and light industrial properties.',
    highlights:  ['Shop & residential', 'Panel upgrades', 'Same-day when available'],
  },
  {
    city:        'Killeen',
    slug:        'killeen-tx',
    county:      'Bell County',
    badge:       '',
    description: 'Electrical repair, installation, and upgrades for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service electrical coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial electrical.',
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, TECL-licensed electricians, and a 2-Year Workmanship Warranty — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12547154400" className={styles.heroCTAPrimary}>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12547154400" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12547154400" className={styles.unlistedCTA}>
            Call (254) 715-4400
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, 2-Year Workmanship Warranty, no contracts ever."
