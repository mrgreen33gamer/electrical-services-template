...
const SERVICE_LINKS = [
  { href: '/services/electrical-repairs',     label: 'Electrical Repairs' },
  ...
  { href: '/services/generator-installation', label: 'Generator Installation' },
];
...
const TRUST_ITEMS = [
  ...
  { icon: faWrench,       label: 'TECL Licensed' },
  { icon: faClock,        label: 'Same-Day Service' },
  { icon: faBolt,         label: '2-Yr Warranty' },
];

const SOCIALS = [
  { href: 'https://facebook.com/brightvoltelectric', icon: faFacebookF, label: 'Facebook' },
  { href: 'https://g.page/r/brightvoltelectric',     icon: faGoogle,    label: 'Google' },
];
          ...
          <div className={styles.brandCol}>
            <Link href="/" className={styles.logo}>
              ...
              <div className={styles.logoText}>
                <span className={styles.logoName}>BrightVolt Electric</span>
                <span className={styles.logoSub}>Waco, Texas</span>
              </div>
            </Link>

            <p className={styles.tagline}>
              Flat-rate pricing. Same-day service. Zero contracts — ever. Serving Central Texas homes and businesses since 2010.
            </p>

            <div className={styles.contactBlock}>
              <a href="tel:+12547154400" className={styles.phoneLink}
                onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Footer Phone', section: 'Footer-Brand' })}>
                <FontAwesomeIcon icon={faPhone} />
                (254) 715-4400
              </a>
              <a href="mailto:hello@brightvoltelectric.com" className={styles.emailLink}
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            &copy; {new Date().getFullYear()} BrightVolt Electric. All Rights Reserved. | TECL License #XXXXXXXX
          </p>
          <a href="tel:+12547154400" className={styles.emergencyBtn}
