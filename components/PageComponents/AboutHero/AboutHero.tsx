      ...
      <div className={styles.heroContainer}>
        ...
        >
          ...
          <h1 className={styles.heroTitle}>
            Central Texas Electrical<br />
            <em>Done Right.</em><br />
            Every Time.
          </h1>
          <p className={styles.heroSubtitle}>
            BrightVolt Electric has been powering homes and businesses in{' '}
          ...
          <div className={styles.imageFrame}>
            <div className={styles.imageWrapper}>
              <Image
                ...
                alt="BrightVolt Electric — Waco, Texas electricians"
                fill
            ...
            <div className={styles.trustCard}>
              ...
              <div className={styles.trustCardText}>
                <span className={styles.trustCardTitle}>BrightVolt Electric</span>
