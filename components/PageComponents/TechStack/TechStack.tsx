...
const DEFAULT_GROUPS: BrandGroup[] = [
  ...
  },
  {
    ...
    items: [
      { name: 'TECL-Licensed',        type: 'cert', icon: '✓' },
      { name: 'Master Electrician',   type: 'cert', icon: '✓' },
...
const TechStack: React.FC<TechStackProps> = ({
  ...
  subtitle = 'We install and service major electrical brands — TECL-licensed crews, no shortcuts on code or materials.',
