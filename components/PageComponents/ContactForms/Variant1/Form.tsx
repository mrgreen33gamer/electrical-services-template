...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'TECL · Insured' },
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed BrightVolt technician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12547154400"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 715-4400', section: 'ContactForm-V1' })}>
                          Call (254) 715-4400
                        </a>
                      </span>
                    </div>
