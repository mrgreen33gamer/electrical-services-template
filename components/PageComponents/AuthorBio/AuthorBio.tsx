...
const personSchema = {
  ...
  worksFor: {
    ...
    url: "https://www.brightvoltelectric.com",
  },
  url: "https://www.brightvoltelectric.com/about",
  sameAs: [
    "https://www.facebook.com/brightvoltelectric",
    "https://www.brightvoltelectric.com",
  ],
  knowsAbout: [
    "Electrical Panel Upgrades", "Residential Wiring", "EV Charger Installation",
    "Generator Installation", "Electrical Safety", "Central Texas Electrical Code",
  ],
  description:
    "Owner of BrightVolt Electric in Waco, TX. TECL-licensed Master Electrician with 15+ years powering Central Texas homes and businesses. Flat-rate pricing, 2-Year Workmanship Warranty.",
};

const AuthorBio: React.FC<AuthorBioProps> = ({
  cityName,
  imageSrc = "/pages/home/welcome/hero-main.jpg",
  imageAlt = "Marcus Hale - Owner of BrightVolt Electric",
}) => {
    ...
    <section className={styles.authorBio} aria-label="About the Author">
      ...
      <div className={styles.card}>
        ...
        <div className={styles.content}>
          <p className={styles.role}>Owner & Master Electrician · BrightVolt Electric</p>
          <h2 className={styles.title}>Marcus Hale</h2>

          <p className={styles.description}>
            15+ years as a TECL-licensed Master Electrician serving Central Texas
          ...
          <ul className={styles.credentials} aria-label="Credentials and specializations">
            <li>TECL-Licensed Master Electrician</li>
            <li>Panel upgrades, wiring, lighting, EV chargers &amp; generators</li>
            <li>2,500+ electrical jobs completed across Central Texas</li>
            <li>Bonded, insured, 2-Year Workmanship Warranty on every install</li>
          </ul>

          <p className={styles.updated}>
            Last updated April 2026 · Based on real local data &amp; 2026 Texas electrical code
          </p>
          ...
          <div className={styles.footer}>
            <a
              ...
              aria-label="Connect with BrightVolt Electric on Facebook"
              onClick={() => trackEvent({
                eventType:    'click',
