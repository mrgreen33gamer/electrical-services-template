...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  },
  {
    ...
    description:
      "Every electrician who enters your home is TECL-licensed. No unlicensed subs working alone — ever.",
  },
  {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every electrical company in Central Texas makes promises. We back ours in writing — with flat-rate pricing, TECL-licensed electricians, and a 2-Year Workmanship Warranty on every install we touch.
          </p>
          <Link
            href={ctaLink}
          ...
          <div className={styles.ratingRow}>
            ...
            <span className={styles.ratingText}>4.9 · 500+ verified Google reviews</span>
          </div>
        </div>
