...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Home Electrical Needs',
  subheading = 'From emergency electrical repairs to panel upgrades and EV chargers, BrightVolt handles it all — on time, on price.',
