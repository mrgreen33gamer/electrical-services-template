      ...
      <div className={styles.inner}>
        ...
        <div className={styles.header}>
          ...
          <h2 className={styles.headline}>
            The electrical challenges most <em>{industry}</em> businesses are stuck with
          </h2>
          <p className={styles.subline}>
            These aren&apos;t abstract problems — they&apos;re costing real downtime, emergency call-outs, and budget overruns every month.
          </p>
        </div>
