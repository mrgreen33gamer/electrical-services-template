...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'BrightVolt Electric',
  address       = '822 Colcord Ave, Waco, TX 76707',
  phone         = '(254) 715-4400',
  email         = 'hello@brightvoltelectric.com',
  googleMapsUrl = 'https://maps.google.com/?q=BrightVolt+Electric+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed electricians.
          </p>
        </div>
